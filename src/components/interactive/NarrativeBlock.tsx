  ...
  return (
    <LessonStep cta={{ label: 'Continue', onClick: onContinue }}>
      <div className="space-y-5">
        <p className="text-lg md:text-[18px] leading-relaxed text-text-primary">
          ...
          <div className="bg-blue-soft rounded-xl px-4 py-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-text-primary/80 leading-relaxed">
        ...
        {section.keyPoints && section.keyPoints.length > 0 && (
          <div className="space-y-3">
            <p className="text-sm font-bold text-text-primary">Key points</p>
            <ul className="space-y-2.5">
              {section.keyPoints.map((point, i) => (
                <li key={i} className="flex items-start gap-3 text-[15px] text-text-primary/85 animate-slide-in" style={{ animationDelay: `${i * 60}ms` }}>
