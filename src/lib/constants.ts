export const LEVELS = [
  ...
  { id: 1, displayNumber: 2, title: 'Your First 30 Minutes in the Terminal', subtitle: 'Navigate, create, and manage files like a developer', lessonCount: 13, mvp: true },
  { id: 2, displayNumber: 3, title: 'Reading and Writing Files', subtitle: 'Look inside files, search for text, and chain commands together', lessonCount: 13, mvp: true },
  { id: 3, displayNumber: 4, title: 'Your Code Has a History', subtitle: 'Git and GitHub — never lose your work again', lessonCount: 17, mvp: false },
